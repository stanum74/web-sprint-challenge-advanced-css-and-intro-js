...
Web accessibility are designed so that people with disablities can browse the web.
2. Talk about 3 different things you can do to ensure your website is accessible. 
3 things that I can ensure on my website to make it accessible is adding alt text to my images, enable resizable text and coloring of my text or headers to make it easier on human's eyes.  
3. How would you explain the concept of a variable to someone new to programming?
Variable is used to store information, their purpose is to label and store data in memory.
4. What is the purpose of using functions in code?
Purpose of a function in code is to check for errors in your web and to keep your code organized.
